                ...
                users && (
                  <div className="bg-white p-8 rounded shadow-lg max-w-lg mx-auto">
                    <form onSubmit={handleSubmit}>
                      ...
                      {/* Gender Input */}
                      <div className="mb-4">
                        <label htmlFor="kelamin" className="block text-sm font-medium text-gray-600 mb-2">
                          Gender
                        </label>
                        <select
                          id="kelamin"
                      ...
                      {/* Subject Input */}
                      <div className="mb-4">
                        <label htmlFor="mapel" className="block text-sm font-medium text-gray-600 mb-2">
                          Subject
                        </label>
                        <input
                          id="mapel"
